...
public class SlaveDataSourceConfig {
    ...
    static final String BASE_PACKAGE = "com.example.normal.mapper.slave";
    ...
    public DataSource slaveDataSource(){
        ...
        druidDataSource.setUsername(myDb2Username);
        druidDataSource.setPassword(myDb2Password);
        druidDataSource.setDriverClassName(myDb2Driver);
        druidDataSource.setUrl(myDb2Url);
